    ...
    public sealed class Config
    {
        ...
        public Config(string path) : this()
        {
            try
            {
                ...
                input_mouse_turn = GetBool(dic, nameof(input_mouse_turn), input_mouse_turn);
        ...
        public void Save(string path)
        {
            try
            {
                using (var writer = new StreamWriter(path))
                {
                    ...
                    writer.WriteLine(nameof(input_mouse_turn) + " = " + BoolToString(input_mouse_turn));
